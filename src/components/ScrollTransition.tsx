...
export const ScrollTransition: React.FC<ScrollTransitionProps> = ({ children }) => {
  ...
  return (
    <div ref={containerRef} className="relative min-h-[50vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          opacity: isVisible ? scrollProgress * 0.8 : 0,
