    ...
    >
      <div
        ...
        style={{
          ...
          border: isHovered ? '1px solid hsla(185, 50%, 55%, 0.2)' : '1px solid hsla(185, 50%, 55%, 0.03)',
          boxShadow: isHovered
      ...
      >
              ...
              style={{
                color:
                  index === activeIndex
                    ...
                    ? 'hsla(210, 20%, 92%, 0.4)'
                    : 'hsla(210, 20%, 92%, 0.15)',
                textShadow: index === activeIndex && isHovered ? '0 0 20px hsla(185, 50%, 55%, 0.5)' : 'none',
              }}
            >
              {chapter.label}
            </button>
        ...
        <div
          ref={dropletRef}
          className={`absolute top-1/2 -translate-y-1/2 rounded-full transition-all ${isDragging ? 'duration-75' : 'duration-500'}`}
          style={{
            left: dropletLeft,
            // NOTE: we no longer need marginLeft hacks because this is a real px anchor
        ...
        >
          {isDragging && <div className="absolute inset-0 rounded-full bg-primary/40 animate-ping" />}
        </div>
