...
export const ExperienceSection = forwardRef<HTMLElement>(
  (props, forwardedRef) => {
    ...
    // Properly merge refs using callback ref
    ...
    useEffect(() => {
      ...
      if (internalSectionRef.current) {
        observer.observe(internalSectionRef.current);
      }
            ...
            <div className="lg:w-2/3 space-y-32">
              ...
              <div ref={aboutRef} id="about" className="scroll-mt-32">
                <p className="font-body text-muted-foreground font-light text-lg leading-relaxed mb-8">
                  ...
                  experience in LLM systems, real-time ML, and 3D/VR
                  development. I thrive in fast-paced, purpose-driven teams
                  where ambition meets action. I am skilled in building
                  scalable, user-focused systems from backend APIs to immersive
                  interfaces. Always open to opportunities where strong vision
                  meets real-world impact! My background combines a solid
                  academic foundation in AI/ML with strong software development
                  skills, honed through valuable professional experiences at
                  leading companies such as BMW Group, Outsight and Theodo.
                </p>
              </div>
